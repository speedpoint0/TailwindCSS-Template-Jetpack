  ...
  <div class="relative">
      ...
      >
        ...
        >
          ...
          <div class="max-w-[720px] lg:max-w-[842px]">
            ...
            <a
              href="#"
              class="mb-6 inline-block rounded-xl bg-black px-8 py-4 text-center font-semibold text-white [box-shadow:rgb(19,_83,_254)_6px_6px] md:mb-10 lg:mb-12"
              >Get Started</a
            >
            <!-- Customers Div -->
            <div class="mb-4 flex w-full max-w-xs items-center">
              <img
                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63905430069fb027f83abb71_Ellipse-3.jpg"
                alt=""
                class="inline-block h-12 w-12 rounded-full object-cover [box-shadow:rgb(0,_0,_0)_0px_6px]"
              />
              <img
                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63905435069fb009d43abbb1_Ellipse-2.jpg"
                alt=""
                class="relative -left-4 -z-[1] inline-block h-12 w-12 rounded-full object-cover [box-shadow:rgb(0,_0,_0)_0px_6px]"
              />
              <img
                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/6390542e809b5c72a0cdcb99_Ellipse.jpg"
                alt=""
                class="relative -left-8 -z-[2] inline-block h-12 w-12 rounded-full object-cover [box-shadow:rgb(0,_0,_0)_0px_6px]"
              />
              <img
                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/6390543797156ee437ef0425_Ellipse-1.jpg"
                alt=""
                class="relative -left-12 -z-[3] inline-block h-12 w-12 rounded-full object-cover [box-shadow:rgb(0,_0,_0)_0px_6px]"
              />
              <div
                class="relative bottom-0 left-[-80px] right-auto top-auto -z-[4] rounded-[29.25px] bg-[#1353fe] py-2 pl-10 pr-5 text-center text-white [box-shadow:rgb(0,_0,_0)_0px_6px]"
              >
                <p class="text-sm">
                  <span class="font-bold">100k+ </span>Customers
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <a
              href="#"
              class="absolute bottom-auto left-[50%] right-auto top-1/2 inline-block max-w-full object-contain font-bold text-[#1353fe] max-[767px]:-translate-x-1/2 max-[767px]:-translate-y-1/2 md:bottom-[-48px] md:left-[-48px] md:right-auto md:top-auto"
            >
              <img
    ...
    <section>
      ...
      <div class="px-5 py-16 md:px-10">
        <!-- Component -->
        <div
          class="mx-auto flex w-full max-w-[798px] flex-col rounded-[36px] bg-black py-8 text-white"
          data-aos="fade-up"
          data-aos-duration="900"
        >
          <!-- Facts Div -->
    ...
    <section>
      <!-- Container -->
      <div
        class="max-w-7xl px-5 py-16 md:px-10 md:py-16 lg:py-24 mx-auto"
        data-aos="fade-up"
        data-aos-duration="900"
      >
        <!-- Heading Div -->
    ...
    <section>
      ...
      >
        <!-- Component -->
        <div
          class="text-center grid grid-cols-1 items-center gap-12 sm:gap-20 lg:grid-cols-2 mx-auto lg:text-left"
        >
          <!-- Heading Div -->
    ...
    <section class="relative">
      ...
      >
        <!-- Component -->
        <div
          class="text-center grid grid-cols-1 items-center gap-12 sm:gap-20 lg:grid-cols-2 lg:text-left"
        >
          <!-- Image Div -->
          <div
      ...
      <img
        ...
        alt=""
        class="bottom-0 left-auto right-0 top-auto hidden max-[991px]:-z-[1] lg:absolute lg:inline-block"
      />
    </section>
      ...
      <div class="max-w-7xl px-5 py-16 md:px-10 md:py-16 lg:py-24 mx-auto">
        ...
        >
          ...
          >
            ...
            <p class="mb-4 text-xl font-semibold">Support</p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipiscing elit ut aliquam,
              purus sit.
            </p>
          ...
          >
            ...
            <p class="mb-4 text-xl font-semibold">Organise</p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipiscing elit ut aliquam,
              purus sit.
            </p>
    ...
    <section class="relative">
      <div class="max-w-7xl px-5 py-16 md:px-10 md:py-16 lg:py-24 mx-auto">
        <!-- Heading Text -->
        <h2 class="text-3xl text-center font-semibold md:text-5xl">
          What
          <span
            class="bg-cover bg-center bg-no-repeat px-4 text-white bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/63915f9749aaab0572c48dae_Rectangle%2018.svg')]"
            >Our Clients</span
        ...
        <div class="mx-auto mb-8 mt-4 max-w-[528px] md:mb-12 lg:mb-16">
          <p class="text-[#636262] text-center">
            Lorem ipsum dolor sit amet consectetur adipiscing elit ut
            aliquam,purus sit amet luctus magna fringilla urna
          </p>
        </div>
        <!-- Testimonial Wall -->
        <div
          class="mb-8 gap-5 py-4 [column-count:1] md:mb-12 md:[column-count:2] lg:mb-16 lg:[column-count:3]"
          data-aos="fade-up"
          data-aos-duration="900"
        >
          <!-- Item -->
          <div
            class="mb-6 gap-6 overflow-hidden rounded-2xl border border-solid border-[#7e7e7e] bg-white p-8"
          >
            ...
            <p class="mb-4 text-sm text-[#636262]">
            ...
            <div class="flex">
              <img
                ...
                alt=""
                class="mr-1.5 inline-block w-4 flex-none"
              />
              <img
                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63904f663019b0ce62f8d5ba_Vector.svg"
                alt=""
          ...
          >
            ...
            <p class="mb-4 text-sm text-[#636262]">
              Euismod scelerisque in netus sed lacinia. Habitant morbi placerat
              tincidunt turpis lacus.
            </p>
            <div class="flex">
              <img
                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63904f663019b0ce62f8d5ba_Vector.svg"
      ...
      <img
        ...
        alt=""
        class="absolute bottom-0 left-0 right-auto top-auto -z-10 inline-block"
      />
      <img
    ...
    <section class="relative bg-[#ffffff]">
      ...
      >
        <!-- Component -->
        <div
          class="flex flex-col items-center justify-start max-[767px]:text-center"
          data-aos="fade-up"
          data-aos-duration="900"
        >
          <h2 class="text-3xl font-semibold md:text-5xl">
          ...
          <!-- Pricing Cards -->
          <div
            class="grid w-full grid-cols-1 gap-8 md:grid-cols-2 md:gap-4 lg:grid-cols-3"
          >
            <div
              class="flex w-full max-w-[416px] flex-col items-start rounded-2xl border border-solid border-[#9b9b9b] bg-white px-8 pb-12 pt-8"
            >
              ...
              <h2 class="mb-4 text-left text-3xl font-semibold md:text-5xl">
                $99<span class="text-sm font-light">/year</span>
              </h2>
              ...
              <div
                class="mb-6 mt-2 flex flex-row items-center md:mb-10 lg:mb-12"
              >
                <img
                  src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63904f663019b065a0f8d592_check-mark.svg"
                  alt=""
              ...
              <a
                href="#"
                class="mx-auto inline-block rounded-xl bg-black px-7 py-4 text-center font-semibold text-white [box-shadow:rgb(19,_83,_254)_6px_6px]"
                >Get started</a
              >
            </div>
            <div
              class="flex w-full max-w-[416px] flex-col items-start rounded-2xl border border-solid border-[#9b9b9b] bg-[#376dfd] px-8 pb-12 pt-8 text-white [box-shadow:rgb(0,_0,_0)_6px_6px]"
            >
              <div class="mb-4 rounded-lg bg-black px-5 py-2">
                <p class="text-sm font-bold text-white">GROWTH</p>
              </div>
              <p class="mb-6 font-light md:mb-10 lg:mb-12">
                Lorem ipsum dolor sit amet consectetur adipiscing elit ut
                aliquam, purus sit
              </p>
              <h2 class="mb-4 text-left text-3xl font-semibold md:text-5xl">
                $149<span class="text-sm font-light">/year</span>
              </h2>
              <div class="mt-2 flex flex-row items-center text-left">
                <img
              ...
              <a
                href="#"
                class="mx-auto inline-block rounded-xl bg-black px-7 py-4 text-center font-semibold text-white [box-shadow:rgb(255,_255,_255)_6px_6px]"
                >Get started</a
              >
            </div>
            <div
            ...
            >
              ...
              <h2 class="mb-4 text-left text-3xl font-semibold md:text-5xl">
                $249<span class="text-sm font-light">/year</span>
              </h2>
              <div class="mt-2 flex flex-row items-center text-left">
                <img
                  src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63904f663019b065a0f8d592_check-mark.svg"
    ...
    <section>
      <!-- Container -->
      <div
        class="mx-auto w-full max-w-5xl px-5 py-16 md:px-10 md:py-16 lg:py-24"
      >
        <!-- Heading -->
        <div
    ...
    <header class="w-full">
      <!-- Container -->
      <div
        class="px-5 py-16 md:px-10 max-w-7xl md:py-16 lg:py-24 mx-auto"
        data-aos="fade-up"
        data-aos-duration="900"
      >
        <!-- Component -->
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between">
          ...
          <div class="flex flex-col lg:mr-20">
            ...
            <div class="flex flex-col">
              <form action="" class="mb-10 mt-5 max-w-[421px]">
                <div class="relative">
                  <label for="email" class="font-inter font-medium"
                  ...
                  <button
                    type="submit"
                    class="absolute right-[15px] top-[55px]"
                  >
                    <img
          ...
          <div class="mt-7 max-w-[700px] grow lg:flex lg:flex-row">
            ...
            >
              <!-- LINK BLOCK -->
              <div
                class="my-5 mr-8 flex max-w-[500px] grow basis-[100px] flex-col space-y-5 lg:my-0"
              >
