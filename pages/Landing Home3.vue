  ...
  <div class="overflow-hidden">
    ...
    <section>
      ...
      >
        <!-- Component -->
        <div
          class="grid grid-cols-1 items-center gap-12 sm:gap-20 lg:grid-cols-2 lg:gap-28"
        >
          <!-- Heading Div -->
          ...
          >
            <img
              ...
              alt=""
              class="h-full w-full max-w-[800px] object-cover"
            />
            <!-- Testimonial Div -->
            <div
    ...
    <section>
      ...
      <div
        ...
        data-aos-duration="900"
      >
        <h5 class="mb-6 text-center text-xl font-semibold md:mb-10 lg:mb-12">
          <span class="text-blue-800">The world’s innovative companies</span>
          use Flowspark
        </h5>
        <div
        ...
        >
          ...
          <div class="flex items-center justify-center">
            <img
              ...
              alt=""
              class="mx-auto inline-block max-w-[80%] max-[767px]:max-w-full"
            />
          </div>
          <!-- Item -->
          <div class="flex items-center justify-center">
    ...
    <section>
      ...
      >
        ...
        >
          ...
          <!-- Image Div -->
          <div class="relative left-4 h-[500px] w-[500px] md:left-0">
            <img
    ...
    <section>
      ...
      >
        ...
        <div class="mx-auto mb-8 w-full max-w-3xl text-center">
          ...
          <p
            class="mx-auto mt-4 max-w-[528px] text-[#636262] md:mb-12 lg:mb-16"
          >
            Lorem ipsum dolor sit amet consectetur adipiscing elit ut
            aliquam,purus sit amet luctus magna fringilla urna
          </p>
    ...
    <section>
      ...
      >
        ...
        <div class="grid items-center gap-8 sm:gap-20 lg:grid-cols-2">
          ...
          <div
            class="mx-auto max-w-xl bg-[#f2f2f7] p-8 text-center rounded-3xl border"
          >
            <!-- Contact Form Title -->
            ...
            >
              <div class="mb-4 flex flex-col gap-y-2">
                ...
                <input
                  type="text"
                  class="h-9 w-full bg-[#FAFAFA] px-3 py-6 text-sm text-[#D8D8D8]"
              ...
              <div class="mb-8 flex flex-col gap-y-2">
                <label for="field-3" class="mb- font-bold">Project Brief</label>
                <textarea
                  placeholder="Enter Your Brief"
                  class="h-auto min-h-[186px] w-full overflow-auto bg-[#FAFAFA] px-3 py-6 text-sm text-[#D8D8D8]"
                >
                </textarea>
              </div>
              <input
