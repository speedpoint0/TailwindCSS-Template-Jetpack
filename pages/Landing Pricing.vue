<template>
  <div class="relative">
    ...
    <section class="relative bg-[#ffffff]">
      <!-- Container -->
      <div
        class="mx-auto w-full px-5 md:px-10 max-w-7xl pt-16 pb-32"
        data-aos="fade-up"
      ...
      >
        ...
        >
          ...
          <!-- Pricing Cards -->
          <div
            class="grid w-full p-[20px] gap-8 md:grid-cols-2 md:gap-4 lg:grid-cols-3"
          >
            <div
              class="flex w-full flex-col items-start rounded-2xl border border-solid border-[#9b9b9b] bg-white px-8 pb-12 pt-8"
            >
            ...
            <div
              class="flex w-full flex-col items-start rounded-2xl border border-solid border-[#9b9b9b] bg-[#376dfd] px-8 pb-12 pt-8 text-white [box-shadow:rgb(0,_0,_0)_6px_6px]"
            >
    ...
    <section class="relative">
      ...
      >
        ...
        >
          What
          <span
            class="bg-contain bg-center bg-no-repeat px-4 text-white bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/639156ce1c70c97aeb755c8a_Rectangle%2010%20(1).svg')]"
            >our clients</span
          >
          are saying
        </h2>
      ...
      >
        ...
        >
          ...
          <form
            name="email-form"
            method=""
            class="relative mx-auto flex w-full max-w-[80%] flex-col md:max-w-[560px]"
          >
            <input
              type="email"
